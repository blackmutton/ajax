    ...
    <div class="container">
        ...
        <form class='form-group mx-auto col-6 mt-5'>
            <div class='d-flex my-2'>
                ...
                <input class="form-control" type="number" name="id" id="id" value="<?= $stu['id'] ?>">
            </div>
            <div class='d-flex my-2'>
                <label for="" class='col-3 form-label'>學號</label>
                <input class="form-control" type="number" name="uni_id" id="uni_id" value="<?= $stu['uni_id'] ?>">
            </div>
            <div class='d-flex my-2'>
                <label for="" class='col-3 form-label'>班級代號</label>
                <input class="form-control" type="number" name="classroom" id="classroom" value="<?= $stu['classroom'] ?>">
            </div>
            <div class='d-flex my-2'>
                <label for="" class='col-3 form-label'>座號</label>
                <input class="form-control" type="number" name="seat_num" id="seat_num" value="<?= $stu['seat_num'] ?>">
            </div>
            <div class='d-flex my-2'>
            ...
            <div class='d-flex my-2'>
                ...
                <input class="form-control" type="date" name="birthday" id="birthday" value="<?= $stu['birthday'] ?>">
            </div>
            <div class='d-flex my-2'>
